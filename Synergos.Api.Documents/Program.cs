...
app.UseStoreWriteGate(
    app.Services.GetRequiredService<IOptions<DocumentStorageOptions>>().Value.Root,
    DocumentRules.CodePrefix,
    app.Configuration.GetValue<int?>("Documents:Storage:WriteGateSeconds"));
