...
app.UseStoreWriteGate(
    app.Services.GetRequiredService<IOptions<IdentityStorageOptions>>().Value.Root,
    IdentityRules.CodePrefix,
    app.Configuration.GetValue<int?>("Identity:Storage:WriteGateSeconds"));
