...
app.UseStoreWriteGate(
    app.Services.GetRequiredService<IOptions<WorkflowStorageOptions>>().Value.Root,
    WorkflowRules.CodePrefix,
    app.Configuration.GetValue<int?>("Workflow:Storage:WriteGateSeconds"));
