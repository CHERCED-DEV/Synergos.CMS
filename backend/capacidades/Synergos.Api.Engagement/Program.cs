...
app.UseStoreWriteGate(
    app.Services.GetRequiredService<IOptions<EngagementStorageOptions>>().Value.Root,
    EngagementRules.CodePrefix,
    app.Configuration.GetValue<int?>("Engagement:Storage:WriteGateSeconds"));
