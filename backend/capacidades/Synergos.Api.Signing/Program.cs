...
app.UseStoreWriteGate(
    app.Services.GetRequiredService<IOptions<SigningStorageOptions>>().Value.Root,
    SigningRules.CodePrefix,
    app.Configuration.GetValue<int?>("Signing:Storage:WriteGateSeconds"));
