...
- **Persistencia**: índice Lucene interno de Examine (`ExternalIndex`), sin store propio; analytics en JSONL por día (`FileSystemSearchAnalyticsStore`, `App_Data/syn-search-analytics/`, retención 90 días).
