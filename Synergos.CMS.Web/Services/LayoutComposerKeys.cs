...
/// veces —<see cref="SynergosIdentitySeeder"/> y <c>DevContentFiller</c>— y el tercer
/// consumidor (<see cref="StarterPortadaSeeder"/>) obligaba a elegir entre copiarla otra vez
/// o unificarla. Tres copias de un GUID que nadie cruza contra el schema es cómo una se
/// queda atrás sin que nada falle: el bloque hijo se guardaría en un area que no existe y la
