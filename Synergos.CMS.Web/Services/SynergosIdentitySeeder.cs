...
public sealed class SynergosIdentitySeeder
{
    ...
    // único area que define elementLayoutSection. El GUID vive en
    // LayoutComposerKeys: tres copias de la Key de un area es cómo una se queda
    // atrás y una página publica vacía sin que nada falle.
