...
///
/// <para><b>No es que faltara: es que se FABRICABA</b> (#110). El wizard la pide en el paso
...
/// uno plausible y equivocado lo lee un comprador y va a tocar el timbre a otra parte.</para>
///
/// <para>Es el gemelo del pin que se tiraba a (0,0) (#103) en este mismo endpoint y de la
...
/// para quien publique sin dirección.</para>
///
/// <para>Este texto vivía como <c>///</c> sobre el parámetro posicional, donde el compilador
/// lo DESCARTA (CS1587): la explicación del defecto que este campo existe para cerrar no
/// llegaba ni a la documentación ni a IntelliSense (#134).</para>
/// </param>
