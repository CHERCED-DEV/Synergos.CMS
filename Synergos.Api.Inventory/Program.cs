...
app.UseStoreWriteGate(
    app.Services.GetRequiredService<IOptions<InventoryStorageOptions>>().Value.Root,
    InventoryRules.CodePrefix,
    app.Configuration.GetValue<int?>("Inventory:Storage:WriteGateSeconds"));
