...
app.UseStoreWriteGate(
    app.Services.GetRequiredService<IOptions<OrderStorageOptions>>().Value.Root,
    OrderRules.CodePrefix,
    app.Configuration.GetValue<int?>("Orders:Storage:WriteGateSeconds"));
