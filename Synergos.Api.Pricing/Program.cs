...
app.UseStoreWriteGate(
    app.Services.GetRequiredService<IOptions<PricingStorageOptions>>().Value.Root,
    PricingRules.CodePrefix,
    app.Configuration.GetValue<int?>("Pricing:Storage:WriteGateSeconds"));
