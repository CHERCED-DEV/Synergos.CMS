...
9. **Tests por seam** — gate liftado post-Ola 190 (ADR 0075). Cada
   ...
   Tests project: **2700 passing**. Memoria `feedback_tests_after_full_migration`
...
├── Synergos.CMS.Tests/          xUnit — 2700 tests passing (gate liftado ADR 0075)
...
de rechazo), `Bff.Core`, `Bff.Salud`, `Bff.Tienda`, `Bff.Eventos`, `Bff.Viajes`. 2700 tests, gates de
