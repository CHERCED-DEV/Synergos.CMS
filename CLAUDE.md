...
9. **Tests por seam** — gate liftado post-Ola 190 (ADR 0075). Cada
   ...
   Tests project: **3034 passing**. Memoria `feedback_tests_after_full_migration`
...
│       ├── ContentTypes/        DocTypes + ElementTypes + Compositions (257 archivos)
│       ├── DataTypes/           131 archivos (67 DTSelect*) + UrlPicker/MediaPicker/Tags/ContentPicker
...
├── Synergos.CMS.Tests/          xUnit — 3034 tests passing (gate liftado ADR 0075)
│   ├── Architecture/            LOS GATES: segregación (17) + molde (12) + capas (8)
│   │                            + imagen de contenedor (6) + compose (11)
...
de rechazo), `Bff.Core`, `Bff.Salud`, `Bff.Tienda`, `Bff.Eventos`, `Bff.Viajes`. 3034 tests, gates de
