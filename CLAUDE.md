...
3. Si es icono: verificar que existe en
   `~/.claude/.../memory/reference_umbraco13_icons.txt` — no inventar.
4. El arquitecto corre uSync Import desde backoffice manualmente para
   aplicar al DB.
...
El agente tiene una memoria persistente en
`~/.claude/projects/c--Users-HITMA-Desktop-synergos/memory/MEMORY.md`.
...
dotnet build Synergos.CMS/Synergos.CMS.Application/Synergos.CMS.Application.csproj -v quiet
