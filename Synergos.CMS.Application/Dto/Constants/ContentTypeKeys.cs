...
{
    /// <summary>
    /// <c>compSeo</c> — Composition providing SEO + OpenGraph metadata:
    /// seoTitle, seoDescription, canonicalLink, ogImage, ogType,
    /// metaRobots (enriched in Ola 43.6a). Composed into every public
    /// Document Type.
    /// </summary>
    /// <remarks>
    /// Source: <c>Synergos.CMS.Web/uSync/v9/ContentTypes/compseo.config</c>.
    /// Consumed by <c>Views/Shared/_SeoHead.cshtml</c> (Ola 44.2) with
    /// fallback cascade to <c>siteConfigSettings.defaultSeoTitle/
    /// Description/socialOgImage</c> per active brand.
    /// </remarks>
